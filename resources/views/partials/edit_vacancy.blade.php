<div class="modal fade" id="edit_vacancy" tabindex="-1" role="dialog" aria-labelledby="edit_vacancy" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal-content rounded">
            ...
            <div class="modal-body admin">
                <!-- form -->
                <form action="{{ url('/edit_vacancy') }}" method="post" role="form" class="php-email-form">
